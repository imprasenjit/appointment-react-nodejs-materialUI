...
export default function PatientMoreMenu(props) {
  ...
  return (
    <>
      ...
      >
        <MenuItem component={RouterLink} to={patientUrl} sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
            <Icon icon={"mdi:file-find"} width={24} height={24} />
          </ListItemIcon>
